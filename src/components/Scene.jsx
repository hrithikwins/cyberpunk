...
export function Model(props) {
  const group = useRef()
  const bakedTexture = useTexture('/textures/gloss_specularGlossiness.png')
          ...
          <group name="Root">
            ...
            <group name="car011">
              <mesh name="car011_0" geometry={nodes.car011_0.geometry} material={materials.cdp_plastic} >
                <meshStandardMaterial attach="material" name="car011_0_material" roughnessMap={bakedTexture} />
              </mesh>
            </group>

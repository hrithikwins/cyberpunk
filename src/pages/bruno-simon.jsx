...
export const BrunoSimon = () => (
  <Canvas shadows gl={{ antialias: false }} camera={{ position: [-30, 35, -15], near: 30, far: 55, fov: 12 }}
    ...
    <Physics gravity={[0, -4, 0]}>
      <ManInSuit position={[1, 0, -1.5]} scale={[0.01, 0.01, 0.01]} />
      {/* <ManInSuit /> */}
      {/* <Hats /> */}
...
//   const { nodes, materials } = useGLTF('/models/bruno-simon/blender-threejs-journey-20k-transformed.glb')
//   return (
